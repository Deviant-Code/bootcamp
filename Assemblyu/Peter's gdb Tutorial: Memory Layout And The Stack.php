...
<meta http-equiv="content-type" content="text/html; charset=windows-1252">
	...
	<link rel="STYLESHEET" type="text/css" href="Peter%27s%20gdb%20Tutorial:%20Memory%20Layout%20And%20The%20Stack_files/style.css" title="Style">
	</head>
	<body>

	<img src="Peter%27s%20gdb%20Tutorial:%20Memory%20Layout%20And%20The%20Stack_files/gnu-head.png" alt="" align="right"><h1>Using GNU's GDB Debugger</h1><h1>Memory Layout And The Stack</h1><h4>By Peter Jay Salzman</h4><hr><table width="100%"><tbody><tr><td align="left">Previous: <a href="http://www.dirac.org/linux/gdb/01-Introduction.php">Introduction</a></td><td align="right">Next: <a href="http://www.dirac.org/linux/gdb/02b-Debugging_With_Your_Brain.php">Debugging With Your Brain</a></td></tr></tbody></table><hr>
...
</p><table style="margin-left: auto; margin-right: auto; font-size: x-small" border="1" cellpadding="8" width="85%">
<tbody><tr>
...
</li><li><b>The heap:</b> Most dynamic memory, whether requested via C's <tt>malloc()</tt> and friends or C++'s <tt>new</tt> is
...
code('02/hello_world-1/hello_world-1.c') ?-->, <a href="http://www.dirac.org/linux/gdb/code/02/hello_world-1/Makefile">Makefile</a>:</p>
...
decimal and hexadecimal format respectively.</p><p>

</p><p>You can also get the size of the sections of the object file using "<tt>objdump -h</tt>" or "<tt>objdump -x</tt>".</p>

<pre class="demo">   $ objdump -h hello_world-1.o 
...
just 'stack'">call stack</span>.  We'll use <a href="http://www.dirac.org/linux/gdb/code/02/hello_world-2/hello_world-2.c">hello_world-2.c</a> for the next example.</p>
...
<td>
	...
	</p><table style="width:90%; margin-left: auto; margin-right: auto; font-size: small" border="1" cellpadding="6">
	<tbody><tr>
...
<td>
	...
	<p style="text-align: center; margin-top: 2em; margin-bottom: 2em">
	</p><table style="margin-left: auto; margin-right: auto; font-size: small" border="1" cellpadding="6" width="90%">
	<tbody><tr>
		<td style="background-color: red">
		Frame for <tt>main()</tt><br>
		</td>
...
<pre class="demo">   gcc -g -o filename filename.c
</pre>
...
<pre class="demo">   gcc -ggdb -o filename filename.c
</pre>

<p></p>which produces debugging information in the most expressive format available, including the GNU enhanced variants
previously discussed.  I believe this is probably the option you want to use in most cases.<p></p>
...
breakpoints yet, but it should be intuitive.  Compile and run <a href="http://www.dirac.org/linux/gdb/code/02/try1.c">try1.c</a>:</p>
...
10.  We can look at the stack by using GDB's <tt>backtrace</tt> command:</p>

<pre class="demo">   (gdb) backtrace
   #0  main () at try1.c:10
   (gdb) 
</pre>
...
<pre class="demo">   (gdb) frame 1                           &lt;--- switch to frame 1
   #1  0x08048455 in main () at try1.c:10
   10         display(x, xptr);
   (gdb) print x
...
<pre class="demo">   x is 5 and is stored at 0xbffffb34.
   xptr holds 0xbffffb34 and points to 5.
</pre>

<p>intermixed with GDB's output:</p>

<pre class="demo">   Starting program: try1
   In main():
   ...
      Breakpoint 1, main () at try1.c:10
   10         display(x, xptr);
...
<p>&nbsp;</p><br><hr><table width="100%"><tbody><tr><td width="33%" align="left"><img src="Peter%27s%20gdb%20Tutorial:%20Memory%20Layout%20And%20The%20Stack_files/prev.png" alt="back"> &nbsp; Back: <a href="http://www.dirac.org/linux/gdb/01-Introduction.php">Introduction</a></td><td align="left"><img src="Peter%27s%20gdb%20Tutorial:%20Memory%20Layout%20And%20The%20Stack_files/up.png" alt="up">   &nbsp;<a href="http://www.dirac.org/linux/gdb">Up</a> to the TOC</td><td align="right">Next: <a href="http://www.dirac.org/linux/gdb/02b-Debugging_With_Your_Brain.php">Debugging With Your Brain</a> &nbsp; <img src="Peter%27s%20gdb%20Tutorial:%20Memory%20Layout%20And%20The%20Stack_files/next.png" alt="next"></td></tr><tr><td></td><td align="left"><img src="Peter%27s%20gdb%20Tutorial:%20Memory%20Layout%20And%20The%20Stack_files/email.png" alt="email"> &nbsp;<a href="mailto:p@dirac.org">Email</a> comments and corrections<br></td></tr><tr><td></td><td align="left"><img src="Peter%27s%20gdb%20Tutorial:%20Memory%20Layout%20And%20The%20Stack_files/printable.png" alt="printable"> &nbsp;<a href="http://www.dirac.org/linux/gdb/02a-Memory_Layout_And_The_Stack.php?printable=yes">Printable</a> version</td><td></td></tr></tbody></table>
	<br>
